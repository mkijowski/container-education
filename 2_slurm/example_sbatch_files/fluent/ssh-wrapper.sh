...
## General notes:
## This wrapper script was developed for running Ansys Fluent inside of a Singularity container.
## It's purpose is to be passed to fluent via the -rsh option and allows fluent built in MPI
